...
const ReviewModal = ({ isOpen, onClose, data}) => {
    ...
    // console.log("🚀 ~ file: ReviewModal.jsx:7 ~ ReviewModal ~ userid:", userid)
    // console.log("🚀 ~ file: ReviewModal.jsx:8 ~ ReviewModal ~ user:", user)
    // console.log("🚀 ~ file: ReviewModal.jsx:5 ~ ReviewModal ~ data:", data)
    ...
    return (
        <div className='fixed top-0 left-0 w-screen h-screen bg-black/50 bg-opacity-25 flex justify-center items-center backdrop-blur-sm'>
            <div className="w-[50%] h-[70%]  rounded-lg flex flex-col">
                ...
                <h1 className='text-center text-2xl'>ภาพพรีวิว</h1>
                        <div className='container grid lg:grid-cols-2 lg:gap-8 bg-white rounded-b-lg shadow-lg'>
                            <div className='flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 container'>
                                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                                    <div>
                                        <img src={data.revimage} alt={data.ticketname} className="mx-auto h-auto w-auto object-cover rounded-lg" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='container p-10'>
                                ...
                                <footer className="mb-2 text-sm text-gray-500 dark:text-gray-400"><p>วันที่รีวิว {moment(data.createddate).locale('th').format('ll')}</p></footer>
                                {ticket.map((res, index) => (

                                    <div key={index}>
                                        {res.ticketid === data.ticketid &&
                                            <p className="text-slate-500 text-md dark:text-gray-400">ชื่อรายการ : {res.ticketname}</p>
                                        }
                                    </div>
                                ))}
                                <p className="text-slate-500 text-sm dark:text-gray-400">คำอธิบาย/รีวิว : {data.revcomment}</p>
                            </div>
                        </div>
                        {/* <br /> */}
                    </div>
