    ...
    return (
        <>
            ...
            {item.map((item, index) => (
                <>
                    {console.clear()}
                    {item.status === true && <div key={index}>
                        <div className='container mt-10 grid lg:grid-cols-2 lg:gap-8 bg-zinc-800/10 rounded-2xl shadow-lg'>
                            <div className='flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 container'>
                                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                                    <div>
                                        <img src={item.revimage} alt={item.ticketname} className="mx-auto h-auto w-auto object-cover rounded-lg" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='container p-10'>
                                ...
                                {ticket.map((res, index) => (
                                    ...
                                    <div key={index}>
                                        {res.ticketid === item.ticketid &&
                                            <p className="text-slate-500 text-md dark:text-gray-400">ชื่อรายการ : {res.ticketname}</p>
                                        }
                                    </div>
                                ))}
