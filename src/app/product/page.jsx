            ...
            <div>
                <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                    ...
                    <div className='grid grid-cols-2 gap-2'>
                        <h2 className="lg:ml-10 text-2xl lg:font-bold tracking-tight dark:text-white xs:text-md xs:font-medium">รายการที่เปิดขาย</h2>
                        <form className="flex items-center">
                            ...
                            <button type="submit" onClick={() => setType("")} className="p-2.5 ml-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                <label>รีเฟรช</label>
                            </button>
                        </form>
                    </div>
                    <div className="border-b border-gray-200 dark:border-gray-700">
                        <ul className="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                            <li className="mr-2">
                                <button onClick={() => setType("")} className="inline-flex p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group" >
                                    <svg aria-hidden="true" className="w-5 h-5 mr-2 text-blue-600 dark:text-blue-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                                    ทั้งหมด
                                </button>
                            </li>
                            <li className="mr-2">
                                <button onClick={() => setType("หมอลำ")} className="inline-flex p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group" aria-current="page">
                                    ...
                                    <BsBoomboxFill className="bi bi-boombox text-blue-600 w-5 h-5 mr-2" />
                                    หมอลำ
                                </button>
                            </li>
                            <li className="mr-2">
                                <button onClick={() => setType("นักร้องเดี่ยว")} className="inline-flex p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group">
                                    <svg aria-hidden="true" className="w-5 h-5 mr-2 text-blue-600 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm-2 4a5 5 0 00-4.546 2.916A5.986 5.986 0 0010 16a5.986 5.986 0 004.546-2.084A5 5 0 0010 11z" clip-rule="evenodd"></path></svg>
                                    นักร้องเดี่ยว
                                </button>
                            </li>
                            <li className="mr-2">
                                <button onClick={() => setType("ทั่วไป")} className="inline-flex p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group">
                            ...
                            <li>
                                <a className="inline-block p-4 text-blue-600 rounded-t-lg cursor-not-allowed dark:text-gray-500">เร็วๆนี้</a>
                            </li>
                        </ul>
                    </div>
                    <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                        {items.map(item => (
                            ...
                            <div className="group relative rounded-lg" key={item.ticketid}>
                                ...
                                <div className="mt-4 flex justify-between">
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm dark:text-white">{item.tickettype}  {item.ticketdesc}</p>
                                        <p className="mt-1 text-sm text-gray-500">เพิ่มเมื่อ {moment(item.createddate).locale('th').format('lll' + ' น.')}</p>
                                    </div>
                                    <br />
                                    <p className="text-sm font-medium text-sky-500">{item.ticketprice} บาท</p>
                                </div>
                                <Link
